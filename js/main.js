...
// スライドショー
    ...
    function slider(){
        ...
        if(posi2<=5){
            ...
            image[cnt].style.display="none"; //左にいったものはdisplaynoneにしましょう
            cnt++;
            if(cnt===image.length){
                cnt=0;
            }
    ...
    window.onload=function(){
        ...
        max_width=0; //一番横幅がある画像
        max_height=0; //一番高さがある画像
        slide=document.getElementById("slide");
        image=slide.getElementsByTagName("li"); //liを指定することによりidを設定する必要がない
